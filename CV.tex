...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            \href{https://github.com/numlinalg/RandLinearAlgebra.jl}{RandLinearAlgebra.jl}
        }
            \textbf{Julia package \texttt{RandLinearAlgebra}}
            \begin{highlights}
                \item RandLinearAlgebra is a Julia package that implements standard Randomized 
                Linear Algebra algorithms and provides means for performance comparison.
        ...
        \begin{twocolentry}{
            \href{https://github.com/Tuna2222/Course-projects}{Course projects}
        }
            \textbf{Course project on optimization}
            \begin{highlights}
                \item Understanding popular optimization tools
                \item Language Used: Matlab, Python, Latex
            \end{highlights}
        \end{twocolentry}
    ...
    \begin{onecolentry}
        ...
        \begin{highlights}
            ...
            \item CS 524, Introduction to Optimization (Fall 2025)
            \item CS 540, Introduction to Artificial Intelligence (Spring 2026)
        \end{highlights}
